...
public class PizzaService {
    ...
    /*public List<PizzaEntity> getAll(){                       Aqui esta la opcion normal de la funcion getAll
    ...
    /*public List<PizzaEntity> getAvailable(){
        System.out.println("this.pizzaRepository.countByVeganTrue() = " + this.pizzaRepository.countByVeganTrue());
    ...
    @Transactional
    public void updatePrice(int idPizza, double price){
        this.pizzaRepository.updatePrice(idPizza,price);
    }
}
